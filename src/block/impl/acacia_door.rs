...
pub const ACACIA_DOOR: BlockDefinition = const_block! {
    identifier: block_id::ACACIA_DOOR,
    states: [
        common::DOOR_HINGE_BIT,
        common::MINECRAFT_CARDINAL_DIRECTION,
        common::OPEN_BIT,
        common::UPPER_BLOCK_BIT,
    ],
    components: [
        ...
        CollisionBoxComponent::new(
            Vec3::new(0.0, 0.0, 0.8125),
            Vec3::new(1.0, 1.0, 0.1875)
        )
    ],
    permutations: [
        const_permutation! {
